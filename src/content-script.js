...
function getStyles(placement, popUpHeight, popUpWidth) {
  ...
  let style = `
    * {
    ...
    .btn-listen {
      margin-right: 6px;
      background-image: url("data:image/svg+xml,%3Csvg width='1em' height='1em' viewBox='0 0 16 16' class='bi bi-volume-up' fill='${
        theme === "dark" ? "%23eeeeee" : "%23000000"
    ...
    .btn-close {
      background-image: url("data:image/svg+xml,%3Csvg width='1em' height='1em' viewBox='0 0 16 16' class='bi bi-x-circle' fill='${
        theme === "dark" ? "%23eeeeee" : "%23000000"
...
overflow: scroll;
    ...
    .link-more::after {
      ...
      background-image: url("data:image/svg+xml,%3Csvg width='1em' height='1em' viewBox='0 0 16 16' class='bi bi-box-arrow-up-right' fill='${
        theme === "dark" ? "%23d9d943" : "blue"
    ...
    .btn-save::before {
      background-image: url("data:image/svg+xml,%3Csvg width='1em' height='1em' viewBox='0 0 16 16' class='bi bi-journal-plus' fill='${
        theme === "dark" ? "%23ffffff" : "%23000000"
      }' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M3 0h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2v-1h1v1a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v1H1V2a2 2 0 0 1 2-2z'/%3E%3Cpath d='M1 5v-.5a.5.5 0 0 1 1 0V5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1zm0 3v-.5a.5.5 0 0 1 1 0V8h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1zm0 3v-.5a.5.5 0 0 1 1 0v.5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1z'/%3E%3Cpath fill-rule='evenodd' d='M8 5.5a.5.5 0 0 1 .5.5v1.5H10a.5.5 0 0 1 0 1H8.5V10a.5.5 0 0 1-1 0V8.5H6a.5.5 0 0 1 0-1h1.5V6a.5.5 0 0 1 .5-.5z'/%3E%3C/svg%3E");
    }
    ...
    .label-save::before {
      background-image: url("data:image/svg+xml,%3Csvg width='1em' height='1em' viewBox='0 0 16 16' class='bi bi-journal-check' fill='${
        theme === "dark" ? "%23ffffff" : "%23000000"
      }' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M3 0h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2v-1h1v1a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v1H1V2a2 2 0 0 1 2-2z'/%3E%3Cpath d='M1 5v-.5a.5.5 0 0 1 1 0V5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1zm0 3v-.5a.5.5 0 0 1 1 0V8h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1zm0 3v-.5a.5.5 0 0 1 1 0v.5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1z'/%3E%3Cpath fill-rule='evenodd' d='M10.854 6.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 8.793l2.646-2.647a.5.5 0 0 1 .708 0z'/%3E%3C/svg%3E");
    }
...
function createPopUp(text) {
  ...
  if (!selectionData.term.trim().length) return;
  ...
  linkMore.setAttribute(
    "href",
    "https://pawtools.org/dictionary?keyword=" + selectedText
  );
...
function updateSaveBtn(key, term) {
  ...
  */
  ...
  browser.storage.local.get("saved").then((item) => {
...
function saveWord(key) {
  ...
  let audio;
  if (popup.audio) audio = popup.audio.getAttribute("src");
...
function updatePopUp(key, data) {
  ...
  if (data.term) popup.querySelector(".term").textContent = data.term;
  ...
  if (data.error) {
    ...
    popup.querySelector(".definition").innerHTML = data.definition;
  }
  ...
  if (container.classList.contains("popup-top")) {
    ...
    container.style.top =
      ...
      (popupInner.getBoundingClientRect().height - popUpHeight) +
      "px";
  }
}
